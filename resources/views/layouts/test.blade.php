...
<link rel="stylesheet" href="https://cdn.datatables.net/buttons/1.0.3/css/buttons.dataTables.min.css">
    ...
    {{-- .customizer-hide #template-customizer .template-customizer-open-btn{display:true/none} --}}
...
@endcan
      ...
      @can('categories_read')
    <li class="menu-item" id="product-categories">
...
<div class="content-wrapper">
  ...
  data-bs-delay="2000" id="toastId">
  <div class="toast-header">
      <i class='bx bx-bell me-2'></i>
      <div class="me-auto fw-medium toast-header-info">Bootstrap</div>
