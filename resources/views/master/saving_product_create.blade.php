@php
    ...
    $code = 'SP_' . str_pad($max_id ? $max_id + 1 : 1, 2, '0', STR_PAD_LEFT);
@endphp
<div class="modal-content">
    <form id='form1'>
        @csrf
        <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLabel1">Tambah Master Simpanan</h5>
        ...
        <div class="modal-footer">
            ...
            <button type="button" p class="btn btn-primary"
                onclick="save('{{ route('product-saving.store') }}','post')"><i class="bx bx-save"></i> Save
                changes</button>
        </div>
    </form>
</div>
